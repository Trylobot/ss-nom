...
//		waypoint_pool.addAll( system.getAsteroids() ); // need to reduce the weight of these, somehow
		...
		{
			TrylobotUtils.debug("could not find any stars, planets, stations, asteroids or jump-buoys in LocationAPI "+(location instanceof StarSystemAPI ? ((StarSystemAPI)location).getName() : "Hyperspace"));
			return;
		}
